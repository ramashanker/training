...
public class RetryMaxProducerFailedTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(RetryMaxProducerFailedTest.class);
    @Autowired
    ...
    public static class TestConfig {
        ...
        public ArtemisProducer artemisProducer() throws Exception {
            ...
            doThrow(new UncategorizedJmsException("Connection lost in during message")).when(jmsTemplate).convertAndSend(Mockito.anyString(), Mockito.anyString());
    ...
    public void test_TopsMessage_Failed_Max_Retry()  {
        ...
        try {
            ...
            responseEntity.andExpect(status().isInternalServerError());
